...
def plot_phik_correlation(
    df, cols: List[str], title: str = "Phi-k Correlation Matrix"
) -> None:
    """
    Computes and plots the Phi-k correlation matrix (supports categorical & numeric data).

    Parameters:
        df (pd.DataFrame): The input dataframe.
        cols (List[str]): List of columns to include in correlation.
        title (str): Title of the plot. Default is "Phi-k Correlation Matrix".
