...
def plot_permutation_importance_grouped(
    pipeline,
    X_val,
    y_val,
    scoring="roc_auc",
    ...
    print(f"\nOriginal feature names from X_val: {original_feature_names}")
...
def plot_ever_married_stripplot(df: pd.DataFrame) -> None:
    """
    Plots a stripplot of Age vs Ever Married, colored by Stroke status.
    """
    ...
    plt.legend(title="Stroke", fontsize=10, title_fontsize=11, loc="lower left")
